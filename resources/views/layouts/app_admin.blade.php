                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('add_movie')}}">Add Movie</a>
                                <a class="dropdown-item" href="{{route('find_movie')}}">Find Movie</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown_user">
                                ...
                                <a class="dropdown-item" href="{{route('find_user')}}">{{ __('Find User') }}</a>
                            </div>
                        </li>
